...
export const metadata = {
  ...
  description:
    "Retour sur des opérations de transfert de céréales conditionnées en sacs menées par Sierra Logistics au Sénégal.",
};
...
export default function TransfertCerealesPage() {
  return (
    ...
    >
      <p>
        Sierra Logistics a pris en charge des opérations de transfert de céréales
